...
@Repository
public interface TransactionRepository extends CrudRepository<Transaction, Long>, ListPagingAndSortingRepository<Transaction, Long>, JpaSpecificationExecutor<Transaction> {
    ...
    Page<Transaction> findAllByBankAccount(BankAccount bankAccount, Pageable pageable, TransactionFilterRequestDto filter);
